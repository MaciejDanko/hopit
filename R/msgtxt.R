...
hopit_msg <- function(x) switch(x,
  ...
  '7'  = 'Something is wrong with survey package.',
  '8'  = 'Please specify fit method',
  '9'  = 'Unknown fit method.',
  '10' = 'Calculating starting parameters...',
  '11' = ' done\nFitting the model...',
  '12' = ' done\nCalculating maximum latent range...',
  '13' = ' done\n',
  '14' = 'Calculating hessian...',
  '15' = ' done\nCalculating estfun...',
  ...
  '29' = 'The treshold formula should be given without dependent variable.', #checks
  '30' = 'The strata formula should be given without dependent variable.', #checks
  '31' = 'Offset not supprted.', #checks
