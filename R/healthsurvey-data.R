...
#' }
#'
#' @source Data was randomly generated using probabilities of occurrence of particular
#' combination of diseases, conditions, sex, age, education, reported health, etc.
