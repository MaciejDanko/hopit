...
*hopit* is an open source software library written in the R [@Rteam2019] and C++ [@RcppEigen2013; @Rcpp2011] programming languages. The *hopit* package provides versatile methods to fit and analyze ordered response data in the context of self reporting behavior (heterogeneity).
...
'Threshold coefficients         ',	'$\\gamma$\n$\\lambda$',	'Coefficients corresponding to each threshold term','')
...
The interactions between latent and threshold variables can be modeled using *crossinter.formula*:
...
I thank Anna Oksuzyan, Oskar Burger, and Laszlo Nemeth for comments to earlier versions of this vignette.
