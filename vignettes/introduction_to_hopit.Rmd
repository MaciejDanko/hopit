...
Reporting behavior analysis is based on the reclassification of individuals into new response categories. There are two methods of reclassification: (1) @Jurges2007 percentile method [see also @Rebelo2014; @OKSUZYAN2019] and (2) reclassification based on estimated thresholds.  
...
The *hopit*() function also has an option to include the survey design using the *survey* package [@Lumley2004; @Lumley2019]. 
