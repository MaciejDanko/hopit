...
Generalized ordered probit model can be fitted using *hopit*() function. The function takes two kinds of formulas: (1) *latent.formula* that models the latent variable and (2) *thresh.formula that models thresholds.   
