...
abstract: The *hopit* package provides R functions to fit and analyze ordered response data in the context of reporting styles. In this vignette we describe the formulation and fit of *hopit* models as well as functions used to analyse reporting styles.
date: "14 XII 2018"
output: pdf_document
---
...
The fit of the model can be accessed using *profile*() function, which calcualte nd plot profile of the log likelihood function around fitted values.
```{r, echo=TRUE}
profile(model3)
```
