...
The *namesf* argument is a function that helps rename the variable names. Here, it removes last 3 letters ("yes") which is a reference level of variable.
...
Typically helatindex takes values between 0 and 1, for the worse
